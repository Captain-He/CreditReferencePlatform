package com.zzu.he.controller.viewcontroller;
...
public class ViewRoute {
	...
	@RequestMapping("/SigalInfo")
	public String getSigalInfo() {
		return "SigalInfo";
	}
